...
namespace sprint0.Sprites.Projectiles
{
    public static class ProjectileArrow
    {
        ...
        private Rectangle RightSourceRect = new Rectangle(0, 22, 22, 22);
        private Rectangle LeftSourceRect = new Rectangle(22, 0 ,22, 22);
        private Rectangle UpSourceRect = new Rectangle(22, 22, 22, 22);
        private Rectangle DownSourceRect = new Rectangle(0, 0, 22, 22);
