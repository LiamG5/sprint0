...
{
    public class ItemRupeeRed: IItem {
        ...
        public ItemRupeeRed(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemRupeeRed(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
