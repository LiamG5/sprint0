...
{
    public class ItemMagicalRod : IItem {
        ...
        public ItemMagicalRod(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemMagicalRod(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
