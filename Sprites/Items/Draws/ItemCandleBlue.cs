...
{
    public class ItemCandleBlue : IItem {
        ...
        public ItemCandleBlue(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemCandleBlue(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
