...
namespace sprint0.Sprites
{
    public class ItemCandleRed : IItem {
        ...
        public ItemCandleRed(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemCandleRed(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
