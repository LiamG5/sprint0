...
{
    public class ItemPotionRed : IItem {
        ...
        public ItemPotionRed(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemPotionRed(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
