...
{
    public class ItemRecorder : IItem {
        ...
        public ItemRecorder(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemRecorder(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
