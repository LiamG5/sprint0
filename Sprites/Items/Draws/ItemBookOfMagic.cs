...
{
    public class ItemBookOfMagic : IItem {
        ...
        public ItemBookOfMagic(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemBookOfMagic(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
