...
{
    public class ItemRedRing : IItem {
        ...
        public ItemRedRing(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemRedRing(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
