...
namespace sprint0.Sprites
{
    public class ItemBoomerang : IItem {
        ...
        public ItemBoomerang(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemBoomerang(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
