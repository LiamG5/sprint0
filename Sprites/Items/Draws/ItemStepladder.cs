...
namespace sprint0.Sprites
{
    public class ItemStepladder : IItem {
        ...
        public ItemStepladder(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemStepladder(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
