...
{
    public class ItemPotionBlue : IItem {
        ...
        public ItemPotionBlue(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemPotionBlue(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
