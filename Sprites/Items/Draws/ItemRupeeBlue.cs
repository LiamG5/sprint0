...
{
    public class ItemRupeeBlue : IItem {
        ...
        public ItemRupeeBlue(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemRupeeBlue(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
