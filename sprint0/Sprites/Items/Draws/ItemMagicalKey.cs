...
{
    public class ItemMagicalKey : IItem {
        ...
        public ItemMagicalKey(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemMagicalKey(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
