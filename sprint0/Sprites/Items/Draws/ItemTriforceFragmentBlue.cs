...
{
    public class ItemTriforceFragmentBlue : IItem {
        ...
        public ItemTriforceFragmentBlue(Texture2D sheet, Vector2 startPosition)
        {
            itemSS = sheet;
            position = startPosition;
        }

        public ItemTriforceFragmentBlue(Texture2D sheet) : this(sheet, new Vector2(200, 100))
        {
        }
